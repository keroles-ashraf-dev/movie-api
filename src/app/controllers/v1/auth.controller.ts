...
import { BaseAuthService } from 'app/services/v1/auth.service';
...
export class AuthController {
    constructor(
        ...
        @inject('BaseAuthService') private authService: BaseAuthService,
    ) { }
    ...
    register = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            return apiRes(res, HttpStatusCode.OK, 'Successfully logged in', null, resData);
        } catch (err) {
    ...
    refreshToken = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            return apiRes(res, HttpStatusCode.OK, 'Successfully new token generated', null, resData);
        } catch (err) {
            next(err); // Pass error to error-handler middleware
        }
    }
